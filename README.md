...
$$f(x_1,x_2,\dots,x_m)=\theta(\mathbf{W}^T \mathbf{x})^T = \left(\theta(\mathbf{w}_1^T \mathbf{x}),\theta(\mathbf{w}_2^T \mathbf{x}),\dots,\theta(\mathbf{w}_C^T \mathbf{x})\right) \approx g(x_1,x_2,\dots,x_m)$$    
